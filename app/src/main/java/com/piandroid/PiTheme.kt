...
// Dark tool cards intentionally stay neutral: semantic color belongs to paths,
// diffs and errors, not the whole command surface.
val DarkPiColors = PiColors(
    bg = Color(0xFF000000),
    headerBg = Color(0xFF05080A),
    panelBg = Color(0xFF0D1116),
    cardBg = Color(0xFF171B21),
    toolBg = Color(0xFF20242A),
    toolPendingBg = Color(0xFF22262D),
    toolSuccessBg = Color(0xFF20242A),
    toolErrorBg = Color(0xFF342428),
    toolTitle = Color(0xFFE2E4E8),
    toolOutput = Color(0xFFA4A9B0),
    toolMeta = Color(0xFF747A83),
    toolDiffAdded = Color(0xFF9FD0AA),
    toolDiffRemoved = Color(0xFFE09A9A),
...
val LightPiColors = PiColors(
    ...
    toolBg = Color(0xFFF1F2F4),
    toolPendingBg = Color(0xFFEEEFF2),
    toolSuccessBg = Color(0xFFF1F2F4),
    toolErrorBg = Color(0xFFF7E6E6),
    toolTitle = Color(0xFF202124),
    toolOutput = Color(0xFF5F646B),
...
val GrayPiColors = PiColors(
    ...
    toolBg = Color(0xFF34373B),
    toolPendingBg = Color(0xFF35383D),
    toolSuccessBg = Color(0xFF34373B),
    toolErrorBg = Color(0xFF423132),
    toolTitle = Color(0xFFF0F1F2),
    toolOutput = Color(0xFFB6BBC1),
